// saladui/core/utils.js
/**
 * Shared utilities for SaladUI framework components:
 * animation/transition helpers (animateTransition, executeAnimation),
 * class-list helpers (addOrRemoveClasses), and DOM traversal (queryDOM).
 */
