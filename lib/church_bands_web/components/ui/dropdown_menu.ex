defmodule ChurchBandsWeb.Components.UI.DropdownMenu do
  @moduledoc """
  ...
  ## Examples:
      ...
      <.dropdown_menu id="user-menu">
        <.dropdown_menu_trigger as={&ChurchBandsWeb.Components.UI.Button.button/1} variant="outline">
          Open Menu
  ...
  * `:class` - Additional CSS classes.
  ...
  attr :variant, :string, values: ~w(default destructive), default: "default"
  attr :disabled, :boolean, default: false
  # Ajuste local (US 1.9): `navigate` e `patch` para o item do menu poder
  # navegar por LiveView, sem recarregar a página.
