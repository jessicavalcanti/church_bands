defmodule ChurchBandsWeb.Components.UI.Form do
  @moduledoc """
  ...
  def form_label(assigns) do
    ...
    ~H"""
    <ChurchBandsWeb.Components.UI.Label.label
  ...
  # Ajuste local (US 1.9): o componente original mostrava só o primeiro erro do
  # campo (`List.first/1`). Uma senha curta e sem número tem dois problemas, e
  # quem está digitando precisa ver os dois — corrigir um de cada vez, com o
  # formulário recusando de novo, é o pior tipo de conversa.
