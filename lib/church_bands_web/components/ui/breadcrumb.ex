defmodule ChurchBandsWeb.Components.UI.Breadcrumb do
  @moduledoc """
  ...
  * Standard HTML link attributes (href, target, etc.) are supported
  """
  attr :class, :string, default: nil
  # Ajuste local (US 1.9): `navigate` e `patch`, para o breadcrumb navegar por
  # LiveView em vez de recarregar a página.
  attr :rest, :global,
    include: ~w(download href navigate patch hreflang ping referrerpolicy rel target type)
